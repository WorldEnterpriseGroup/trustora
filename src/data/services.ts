...
export const serviceDetails: Record<string, { eyebrow: string; title: string; intro: string; imageKey: ServiceMediaKey; supportImageKey: ServiceMediaKey; path: { title: string; body: string }[]; sections: { heading: string; body: string; items?: string[] }[] }> = {
  'employer-of-record': {
