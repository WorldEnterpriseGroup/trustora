...
const pages = ['/', '/services/', '/what-is-eor/', '/insights/', '/about/', '/careers/', '/careers/govcon-fellowship/', '/contact/', '/eor/', '/eor-readiness/', '/resources/', '/briefings/', '/eor-brief/', '/faq/', '/industries/', '/locations/', '/country-parameters/', '/workplace/', '/employee-experience/', '/first-international-hire/', '/eor-country-readiness/', '/eor-for-ai-ml-teams/', '/quantum-science-hiring-brief/', '/remote-employee-setup/', '/office-space-and-eor/', '/cross-border-work-risk-review/', '/employee-experience-brief/', '/specialist-hiring-intake/', '/frontier-talent-operating-plan/', '/internships-and-early-career-program/', '/asia-pacific-workforce-readiness/', '/workforce-risk-governance-review/', '/legal/privacy/', '/legal/terms/', '/legal/entities/', '/legal/policy/'];
